...
from .App.views import legal_assistance_check_view, simple_query_analysis_view, complex_tasks_view, document_generation_check_view
...
urlpatterns = [
    ...
    path('api/document_generation_check/', document_generation_check_view, name='document_generation_check'),
]
